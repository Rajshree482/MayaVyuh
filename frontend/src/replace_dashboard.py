...
with open(r'c:\Users\ayush\Downloads\GFG\MayaVyuh\frontend\src\AdminComponents.jsx', 'r', encoding='utf-8') as f:
    code = f.read()

pattern = re.compile(r'const ImageBankModal = .*', re.DOTALL)

replacement = """const MayaNexusNav = ({ active, setActive }) => {
...
with open(r'c:\Users\ayush\Downloads\GFG\MayaVyuh\frontend\src\AdminComponents.jsx', 'w', encoding='utf-8') as f:
    f.write(new_code)
